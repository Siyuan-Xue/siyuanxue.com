...
import { resolveLocale, localeOrigin } from '../src/i18n/locale';
...
describe('authoritative build locale', () => {
 ...
 test('each language is bound to its own domain', () => { expect(localeOrigin('zh')).toBe('https://xuesiyuan.com'); expect(localeOrigin('en')).toBe('https://siyuanxue.com'); });
});
